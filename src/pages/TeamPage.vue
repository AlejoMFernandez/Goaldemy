  ...
  <div class="min-h-screen bg-transparent text-white">
    ...
    <div v-else-if="teamData" class="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div class="transition-all duration-300">
        ...
        <!-- Peña Tab: hinchas de Fulvo que eligieron este equipo -->
        <div v-if="activeTab === 'penia'" class="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-white/10 p-4 md:p-6">
          ...
          <p class="text-sm text-slate-400 mb-4">Hinchas de {{ teamData?.name }} en Fulvo, rankeados por XP del período.</p>
          ...
          <div v-else-if="!peniaMembers.length" class="py-10 text-center">
            <p class="text-slate-300 text-sm font-medium">Todavía no hay hinchas de {{ teamData?.name }} en Fulvo</p>
...
// Peña: hinchas de Fulvo que eligieron este equipo como favorito
