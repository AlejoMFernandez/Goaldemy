<template>
  <div class="la-liga-page py-8 px-4">
    <div class="container mx-auto max-w-7xl">
      ...
      <div class="league-header mb-6">
        <div class="flex items-center gap-3">
          ...
          />
          <div>
            <h1 class="text-3xl font-bold text-white mb-0">La Liga</h1>
            <p class="text-slate-400 text-sm mb-0">España</p>
          </div>
        </div>
      </div>
      ...
      <div v-if="loading" class="text-center py-20">
        ...
        <p class="mt-4 text-slate-300">Cargando datos de La Liga...</p>
      </div>
  ...
  setup() {
    ...
    const loadLeagueData = async () => {
      try {
        ...
        const data = await getLeagueOverview(LEAGUES.LA_LIGA.id);
        ...
        console.error('Error loading La Liga data:', err);
        error.value = 'Error al cargar los datos de La Liga. Intentá de nuevo más tarde.';
      } finally {
        loading.value = false;
      }
    };
