    ...
    <div class="relative z-10 max-w-4xl mx-auto px-6 pt-12 md:pt-20 pb-16 md:pb-24">
      <div class="space-y-6 text-center">
        ...
        <div class="flex flex-wrap gap-4 pt-6 justify-center">
          ...
          <RouterLink v-if="!state.isAuthenticated" to="/register" class="rounded-xl border border-white/10 px-6 py-3 font-semibold text-slate-200 transition hover:border-white/20 hover:text-white hover:bg-white/5 backdrop-blur">
            Crear cuenta
          </RouterLink>
        </div>
      </div>
