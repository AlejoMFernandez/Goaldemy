...
export default {
  name: 'AppFooter',
  components: { RouterLink, GoaldemyLogo }
}
</script>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div class="space-y-4">
          ...
          <p class="text-slate-400 text-sm leading-relaxed max-w-xs">
            La plataforma de aprendizaje gamificado de fútbol que transforma tu pasión en progreso.
          </p>
          <div class="flex items-center gap-3">
            <!-- Social links -->
            <a href="https://github.com/AlejoMFernandez" target="_blank" rel="noopener" class="group inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-slate-400 transition hover:border-emerald-400/40 hover:text-emerald-400 hover:bg-emerald-500/5">
            ...
            <a href="https://www.instagram.com/goaldemyapp/" target="_blank" rel="noopener" class="group inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-slate-400 transition hover:border-pink-400/40 hover:text-pink-400 hover:bg-pink-500/5">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li><RouterLink to="/leaderboards" class="text-slate-400 hover:text-emerald-400 transition">Leaderboards</RouterLink></li>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li><RouterLink to="/about/goaldemy" class="text-slate-400 hover:text-cyan-400 transition">¿Qué es Goaldemy?</RouterLink></li>
