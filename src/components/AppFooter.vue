...
export default {
  name: 'AppFooter',
  components: { RouterLink, FulvoLogo }
}
</script>
  ...
  <footer class="relative border-t border-white/10 bg-gradient-to-t from-slate-900/90 to-slate-900/40 backdrop-blur">
    <div class="container mx-auto px-6 pt-10 pb-24">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <!-- Brand Column -->
        <div class="space-y-4">
          <FulvoLogo variant="full" size="md" />
          <p class="text-slate-400 text-sm leading-relaxed max-w-xs">
            La plataforma de aprendizaje gamificado de fútbol que transforma tu pasión en progreso.
          </p>
          <div class="flex items-center gap-3">
            <!-- TODO: actualizar el handle cuando se cree @fulvo... en Instagram -->
            <a href="https://www.instagram.com/goaldemyapp/" target="_blank" rel="noopener" aria-label="Instagram de Fulvo" class="group inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-slate-400 transition hover:border-pink-400/40 hover:text-pink-400 hover:bg-pink-500/5">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li><RouterLink to="/about/fulvo" class="text-slate-400 hover:text-cyan-400 transition">¿Qué es Fulvo?</RouterLink></li>
