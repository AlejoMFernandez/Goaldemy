          ...
          <tr v-else v-for="(r, i) in rows" :key="r.user_id" :class="[
            ...
            <td class="px-2 sm:px-3 py-2" style="max-width: 140px;">
              <div class="flex items-center gap-1.5 min-w-0">
                <div :class="['flex-shrink-0 rounded-[9px]', frameStyle(r.frameKey).wrap, frameStyle(r.frameKey).pad]">
                  <div :class="['h-6 w-6 sm:h-7 sm:w-7 rounded-[7px] overflow-hidden grid place-items-center text-[11px] sm:text-sm', r.iconGlyph ? iconThemeBg(r.iconGlyph) : iconBgStyle(r.iconBg)]">
